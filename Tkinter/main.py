# Componenti gruppo: Bono, Ghebrous, Porta
...
frame = ctk.CTkScrollableFrame(window,width=800, height=510) #,width=800, height=400
frame.grid(row=1,columnspan=6,column=0,sticky='nsew')
...
def visualizza_utenti(x):
    ...
    for i, user in enumerate(users):
        ...
        modifica = ctk.CTkButton(frame,text="Modifica" ,command=lambda x=lista[i]: finestra_modifica(x))
        modifica.grid(row=i+2,column=4,sticky="WE",padx=20)
        labels.append(modifica)
        cancella = ctk.CTkButton(master=frame,text="Cancella",hover_color='#52170b',fg_color='red' ,command=lambda x=lista[i]: cancella_utente(x))
...
header1 = ctk.CTkLabel(master=frame, text="Id ",font=('Chaparral Pro', 18, 'bold'))
header1.grid(row=1, column=0,padx=10,pady=10,sticky="W")
header2 = ctk.CTkLabel(master=frame, text="Username ",font=('Chaparral Pro', 18, 'bold'))
header2.grid(row=1, column=1,padx=10,pady=10,sticky="W")
header3 = ctk.CTkLabel(master=frame,padx=0,pady=10, text="Email ",font=('Chaparral Pro', 18, 'bold'))
header3.grid(row=1, column=2,padx=10,pady=10,sticky="W")
header4 = ctk.CTkLabel(master=frame, text="Password ",font=('Chaparral Pro', 18, 'bold'))
